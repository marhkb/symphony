    ...
    impl ObjectImpl for NetworkCard {
        ...
        fn constructed(&self) {
            ...
            let network_name_expr = network_inner_expr.chain_closure::<String>(closure!(
                |_: Self::Type, inner: model::BoxedNetwork| { inner.network_interface.clone() }
            ));
            ...
            let css_classes = utils::css_classes(self.public_box.upcast_ref());
            ...
            let css_classes = utils::css_classes(self.dns_box.upcast_ref());
            ...
            let css_classes = utils::css_classes(self.ipv6_box.upcast_ref());
